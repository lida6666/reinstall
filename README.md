...
- dd完成需要检查dns设置，改回正常的dns服务器
- https://github.com/bin456789/reinstall/issues/353

# reinstall

[![Codacy](https://img.shields.io/codacy/grade/dc679a17751448628fe6d8ac35e26eed?logo=Codacy&label=Codacy&style=flat-square)](https://app.codacy.com/gh/lida6666/reinstall/dashboard)
[![CodeFactor](https://img.shields.io/codefactor/grade/github/lida6666/reinstall?logo=CodeFactor&logoColor=white&label=CodeFactor&style=flat-square)](https://www.codefactor.io/repository/github/lida6666/reinstall)
[![Lines of Code](https://aschey.tech/tokei/github/lida6666/reinstall?category=code&label=Lines%20of%20Code&style=flat-square)](https://github.com/aschey/vercel-tokei)
<!-- [![Lines of Code](https://tokei.rs/b1/github/lida6666/reinstall?category=code&label=Lines%20of%20Code&style=flat-square)](https://github.com/XAMPPRocky/tokei_rs) -->
...
请我喝奶茶：
[![Donate](https://img.shields.io/badge/Donate-30363D?style=for-the-badge&logo=GitHub-Sponsors&logoColor=#EA4AAA)](https://github.com/sponsors/lida6666)

[![Sponsors](https://raw.githubusercontent.com/lida6666/sponsors/refs/heads/master/sponsors.svg)](https://github.com/sponsors/lida6666)

### 反馈

[![GitHub Issues](https://img.shields.io/badge/GitHub-%23121011.svg?style=for-the-badge&logo=github&logoColor=white)](https://github.com/lida6666/reinstall/issues)
...
| <img width="16" height="16" src="https://github.com/lida6666/reinstall/assets/7548515/f74b3d5b-085f-4df3-bcc9-8a9bd80bb16d" /> Kali                                                                                                                                                                                                                                   | 滚动                                  | 256 MB    | 1 ~ 1.5 GB ^ |
...
```bash
curl -O https://raw.githubusercontent.com/lida6666/reinstall/main/reinstall.sh || wget -O ${_##*/} $_
```

国内服务器：

```bash
curl -O https://cnb.cool/lida6666/reinstall/-/git/raw/main/reinstall.sh || wget -O ${_##*/} $_
```
...
- <https://raw.githubusercontent.com/lida6666/reinstall/main/reinstall.bat>
...
```batch
certutil -urlcache -f -split https://raw.githubusercontent.com/lida6666/reinstall/main/reinstall.bat
```

国内服务器：

```batch
certutil -urlcache -f -split https://cnb.cool/lida6666/reinstall/-/git/raw/main/reinstall.bat
```
...
![Windows 安装界面](https://github.com/lida6666/reinstall/assets/7548515/07c1aea2-1ce3-4967-904f-aaf9d6eec3f7)
...
![image-name](https://github.com/lida6666/reinstall/assets/7548515/5aae0a9b-61e2-4f66-bb98-d470a6beaac2)
...
从 <https://github.com/lida6666/reinstall/commits/main> 右侧找到旧版本的 `commit_id`

将下面脚本的 `xxxxxxxx` 替换成旧版本的 `commit_id` 并运行脚本

```bash
commit_id=xxxxxxxx
curl -O https://raw.githubusercontent.com/lida6666/reinstall/$commit_id/reinstall.sh || wget -O ${_##*/} $_
...
[![Oracle Cloud](https://github.com/lida6666/reinstall/assets/7548515/8b430ed4-8344-4f96-b4da-c2bda031cc90)](https://www.oracle.com/cloud/)
[![DartNode](https://github.com/lida6666/reinstall/assets/7548515/435d6740-bcdd-4f3a-a196-2f60ae397f17)](https://dartnode.com/)
